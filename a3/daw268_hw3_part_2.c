//Compiling:
//mpicc -O3 -std=gnu99 -Wall daw268_hw3_part_2.c -o p2 -lm

//Running
// Note: the program must be recompiled for each different MxN matrix and/or NUM_PROCS

//Running with <NUM_PROCS>
//mpirun -mca plm_rsh_no_tree_spawn 1 -bind-to core --hostfile p2_hostfile -np <NUM_PROCS> ./p2
...
int main(int argc, char **argv)
{
  ...
  DEBUG("Node '%s' (rank %d) online and reporting for duty!", processor_name, cord);
